/***************************************************************************//**
 * @file    user_settings_default.h
 * @brief   Arduino wolfSSL library default user settings header
 * @author  onelife <onelife.real[at]gmail.com>
 ******************************************************************************/

#ifndef __USER_SETTINGS_DEFAULT_H__
#define __USER_SETTINGS_DEFAULT_H__
...
extern struct tm* user_XGMTime(const time_t* timer, struct tm* tmp);
#define XTIME user_XTime
#define XGMTIME user_XGMTime
...
#endif /* __USER_SETTINGS_DEFAULT_H__ */
